...
if ($g_display_footer)
{
    ...
    $website->AppendHtmlLine("<footer class='footer text-center py-2 small text-muted'><div class='container'>Created by Petr Bena [petr@bena.rocks] (c) 2018 - 2026, source code at ".
